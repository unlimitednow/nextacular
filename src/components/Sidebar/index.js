...
const Sidebar = ({ menu }) => {
  ...
  return (
    <aside className="sticky z-40 flex flex-col space-y-5 text-white bg-black-800 dark:bg-gray-900 md:overflow-y-auto md:w-1/4 md:h-screen overscroll-contain">
      <div className="relative flex items-center justify-center p-5 text-center border-b border-b-gray-900">
        <Link href="https://accounts.unlimitpotential.com/dashboard">
          <a className="flex-grow text-2xl font-bold">Unlimited Now</a>
        </Link>
