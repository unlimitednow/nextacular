...
const Sidebar = ({ menu }) => {
  ...
  return (
    <aside className="sticky z-40 flex flex-col space-y-5 text-black bg-black-800 dark:bg-gray-900 md:overflow-y-auto md:w-1/4 md:h-screen overscroll-contain">
